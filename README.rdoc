...
For development, you can run the application from the command line:
    ...
    $ ruby lib/voteatx.rb
    [2013-10-19 11:48:55] INFO  WEBrick 1.3.1
    [2013-10-19 11:48:55] INFO  ruby 1.9.3 (2012-04-20) [x86_64-linux]
    == Sinatra/1.4.3 has taken the stage on 4567 for development with backup from WEBrick
    [2013-10-19 11:48:55] INFO  WEBrick::HTTPServer#start: pid=5291 port=4567
...
The database must be regenerated for each election. See the "db/data" directory
